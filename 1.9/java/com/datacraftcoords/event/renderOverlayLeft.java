...
public class renderOverlayLeft {
	...
	public static void renderItLeft(boolean Enabled, boolean chunkEnabled, boolean LightEnabled) {
	...
	if(!varBiome.equals("Hell") && !varBiome.equals("The End")){
    	...
    	mc.fontRendererObj.drawStringWithShadow(TextFormatting.YELLOW + "O: " + coordinateString + " " + TextFormatting.RED + yawCalc() + TextFormatting.WHITE + " T:" + CalculateMessageForInfoLine(null), varX, 2, 0xffffff);
    	...
    	mc.fontRendererObj.drawStringWithShadow(TextFormatting.LIGHT_PURPLE + "N: " + coordinateString2 + TextFormatting.GREEN + " XP: " + getXP(), varX, 12, 0xffffff);
    	...
    	mc.fontRendererObj.drawStringWithShadow(TextFormatting.LIGHT_PURPLE + "N: " + coordinateString3 + " " + TextFormatting.RED + yawCalc() + TextFormatting.WHITE + " T:" + CalculateMessageForInfoLine(null), varX, 2, 0xffffff);
    	...
    	mc.fontRendererObj.drawStringWithShadow(TextFormatting.YELLOW + "O: " + coordinateString4 + TextFormatting.GREEN + " XP: " + getXP(), 2, 12, 0xffffff);
    	...
    	coordinateString3 = coordinateString3.replace("{z}", Integer.toString(GetZCoordinate()));
    	/** Display Nether Coords */
    	mc.fontRendererObj.drawStringWithShadow(TextFormatting.LIGHT_PURPLE + "E: " + coordinateString3 + " " + TextFormatting.RED + yawCalc() + TextFormatting.WHITE + " T:" + CalculateMessageForInfoLine(null), varX, 2, 0xffffff);
    	mc.fontRendererObj.drawStringWithShadow("" + TextFormatting.GREEN + " XP: " + getXP(), varX, 12, 0xffffff);
	}
