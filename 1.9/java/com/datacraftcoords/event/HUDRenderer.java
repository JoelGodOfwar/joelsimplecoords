...
private static Minecraft mc = Minecraft.getMinecraft();
	...
	private static void RenderTexture(int x, int y, TextureAtlasSprite textureAtlasSprite, int width, int height, double zLevel)
	{
        ...
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_NORMAL);//startDrawingQuads();
        //addVertexWithUV
        worldrenderer.pos((double)(x), 			(double)(y + height), 	(double)zLevel).tex((double)textureAtlasSprite.getMinU(), (double)textureAtlasSprite.getMaxV());
        worldrenderer.pos((double)(x + width), 	(double)(y + height), 	(double)zLevel).tex((double)textureAtlasSprite.getMaxU(), (double)textureAtlasSprite.getMaxV());
        worldrenderer.pos((double)(x + width), 	(double)(y), 			(double)zLevel).tex((double)textureAtlasSprite.getMaxU(), (double)textureAtlasSprite.getMinV());
        worldrenderer.pos((double)(x), 			(double)(y), 			(double)zLevel).tex((double)textureAtlasSprite.getMinU(), (double)textureAtlasSprite.getMinV());
        tessellator.draw();
	}
    ...
    public static void RenderFloatingText(String[] text, float x, float y, float z, int color, boolean renderBlackBackground, float partialTickTime)
    {
        ...
        if(renderBlackBackground)
        {
            ...
            worldrenderer.pos(-stringMiddle - 1, -1 + 0, 0.0D);
            worldrenderer.pos(-stringMiddle - 1, 8 + lineHeight*text.length-lineHeight, 0.0D);
            worldrenderer.pos(stringMiddle + 1, 8 + lineHeight*text.length-lineHeight, 0.0D);
            worldrenderer.pos(stringMiddle + 1, -1 + 0, 0.0D);
            tessellator.draw();
