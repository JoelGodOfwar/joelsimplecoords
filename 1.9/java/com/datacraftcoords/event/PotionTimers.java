...
public class PotionTimers {
    ...
    protected static int potionLocY = 22;
    ...
    public static void RenderOntoHUD()
    {
                    ...
                    !mc.gameSettings.showDebugInfo) //|| (mc.currentScreen instanceof GuiChat)) &&
        {
	         ...
	         */
    		if(MyMessage.plgPTenabled){	
	    		//mc.fontRendererObj.drawStringWithShadow("CS: " + (mc.currentScreen == null) + "", 2, 60, 0xffffff);
    			Collection<PotionEffect> collection = mc.thePlayer.getActivePotionEffects();	//key:potionId, value:potionEffect
    			if (!collection.isEmpty())
    	        {
		            ...
		            for (PotionEffect potioneffect : Ordering.natural().reverse().sortedCopy(collection))
		            {
		                ...
		                //{
		                int k = resolution.getScaledWidth() + 2;
	    				int l = 25; // Height / Y
		                	...
		                	if(ShowPotionIcons)
		                	{
		                		...
		                		UsePotionColors = false;
		                		DrawPotionDuration(k, l, potion, potioneffect);
	...
	{
		String durationString = Potion.getPotionDurationString(potionEffect, 1);
