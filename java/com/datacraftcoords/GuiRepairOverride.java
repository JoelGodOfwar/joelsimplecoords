    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if(leftItemStack != null)
        {
        	...
        	if(timesRepaired >= maxRepairTimes)
        		leftItemRepairCost = "" + EnumChatFormatting.DARK_RED + timesRepaired + EnumChatFormatting.DARK_GRAY + "/" + maxRepairTimes;
        	else
        		leftItemRepairCost = "" + EnumChatFormatting.DARK_GRAY + timesRepaired + "/" + maxRepairTimes;
        ...
        if(rightItemStack != null)
        {
        	...
        	if(timesRepaired >= maxRepairTimes)
        		rightItemRepairCost = "" + EnumChatFormatting.DARK_RED + timesRepaired + EnumChatFormatting.DARK_GRAY + "/" + maxRepairTimes;
        	else
        		rightItemRepairCost = "" + EnumChatFormatting.DARK_GRAY + timesRepaired + "/" + maxRepairTimes;
        ...
        if(leftItemStack != null && rightItemStack != null)
        {
        	...
        	String finalItemRepairCost = "" + EnumChatFormatting.DARK_GRAY + timesRepaired+"/" + maxRepairTimes;
